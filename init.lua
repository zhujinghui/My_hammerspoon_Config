...
-- Hints
hs.hotkey.bind(dribleShift, 'h', function() 
...
local leftHalf      = hs.hotkey.bind(hyper, ',', function() locationSet(0, 0, halfMaxWidth, hs.grid.GRIDHEIGHT) end)
local rightHalf     = hs.hotkey.bind(hyper, '.', function() locationSet(halfMaxWidth, 0, halfMaxWidth, hs.grid.GRIDHEIGHT) end)

local fullScreen    = hs.hotkey.bind(hyper, 'm', function() hs.grid.maximizeWindow() end)
